...
const ClassificationThree = () => {
  const [messages, setMessages] = React.useState([
    { id: 1, text: "This query has been classified as Category Three. How can I help you?", sender: 'ai' }
  ]);
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      setMessages(prev => [...prev, { 
        id: Date.now(), 
        text: "I'm processing your Category Three query. A support agent will respond shortly.", 
        sender: 'ai' 
      }]);
    }, 1000);
  };
      ...
      <Card className="glass-card" sx={{ mb: 3 }}>
        <CardContent>
          <Typography variant="h5" sx={{ fontWeight: 700, mb: 1 }}>
            Category Three Dashboard
          </Typography>
          <Typography variant="body1" color="text.secondary">
            This dashboard handles queries related to access control, permissions, and security-related issues.
          </Typography>
        </CardContent>
      </Card>
