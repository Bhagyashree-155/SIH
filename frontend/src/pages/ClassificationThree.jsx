...
const ClassificationThree = ({ onCategoryResponse }) => {
  ...
  const category = 'Access & Security';
    ...
    try {
      ...
      if (response.category === category) {
        ...
        if (onCategoryResponse) {
          onCategoryResponse(`✅ Access & Security ticket created: ${response.ticket_number}\n\n**Query:** ${newQuery}\n**Priority:** ${response.priority}\n**Subcategory:** ${response.subcategory}\n**Confidence:** ${response.confidence}%\n\n**Suggested Solutions:**\n${response.suggested_solutions?.join('\n• ') || 'No specific solutions provided'}`);
        }
        ...
        if (onCategoryResponse) {
          onCategoryResponse(`❌ Query misclassified: "${newQuery}" was classified as "${response.category}" instead of Access & Security. Please redirect to the correct category tab.`);
        }
      }
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
            ...
            <Box>
              ...
              <Typography variant="body1" sx={{ color: '#64748b' }}>
                Access control, permissions, and security-related issues
              </Typography>
            </Box>
          </Box>
            ...
            <Card sx={{ mb: 3 }}>
              <CardContent>
                ...
                <TextField
                  ...
                  multiline
                  rows={3}
                  placeholder="Describe your access control or security issue..."
                  value={newQuery}
            ...
            <Card sx={{ height: '600px' }}>
              {selectedTicket ? (
                ...
                <Box sx={{ 
                  ...
                  <SecurityIcon sx={{ fontSize: 80, color: '#e5e7eb', mb: 2 }} />
...
export default ClassificationThree;
