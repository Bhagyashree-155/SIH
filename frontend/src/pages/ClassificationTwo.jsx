...
const ClassificationTwo = ({ onCategoryResponse }) => {
  ...
  const category = 'Software & Digital Services';
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
            ...
            <Box>
              ...
              <Typography variant="body1" sx={{ color: '#64748b' }}>
                Software issues, application errors, and digital service problems
              </Typography>
            </Box>
          </Box>
              ...
              <Card sx={{ background: 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)', color: 'white' }}>
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <SoftwareIcon sx={{ fontSize: 40, opacity: 0.8 }} />
                  </Box>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Card sx={{ mb: 3 }}>
              <CardContent>
                ...
                <TextField
                  ...
                  multiline
                  rows={3}
                  placeholder="Describe your software or digital service issue..."
                  value={newQuery}
            ...
            <Card sx={{ height: '600px' }}>
              {selectedTicket ? (
                ...
                <Box sx={{ 
                  ...
                  <SoftwareIcon sx={{ fontSize: 80, color: '#e5e7eb', mb: 2 }} />
