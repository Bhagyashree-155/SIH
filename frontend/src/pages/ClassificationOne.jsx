...
const ClassificationOne = () => {
  const [messages, setMessages] = React.useState([
    { id: 1, text: "This query has been classified as Category One. How can I help you?", sender: 'ai' }
  ]);
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      setMessages(prev => [...prev, { 
        id: Date.now(), 
        text: "I'm processing your Category One query. A support agent will respond shortly.", 
        sender: 'ai' 
      }]);
    }, 1000);
  };
  ...
  return (
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <Card className="glass-card" sx={{ mb: 3 }}>
        <CardContent>
          ...
          <Typography variant="body1" color="text.secondary">
            This dashboard handles queries related to hardware issues, system failures, and physical infrastructure problems.
          </Typography>
        </CardContent>
      </Card>
      ...
      >
        <Box sx={{ p: 2, bgcolor: '#3b82f6', color: 'white' }}>
