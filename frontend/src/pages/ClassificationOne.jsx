...
const ClassificationOne = ({ onCategoryResponse }) => {
    ...
    try {
      ...
      if (response.category === category) {
        ...
        if (onCategoryResponse) {
          onCategoryResponse(`✅ Hardware & Infrastructure ticket created: ${response.ticket_number}\n\n**Query:** ${newQuery}\n**Priority:** ${response.priority}\n**Subcategory:** ${response.subcategory}\n**Confidence:** ${response.confidence}%\n\n**Suggested Solutions:**\n${response.suggested_solutions?.join('\n• ') || 'No specific solutions provided'}`);
        }
        ...
        if (onCategoryResponse) {
          onCategoryResponse(`❌ Query misclassified: "${newQuery}" was classified as "${response.category}" instead of Hardware & Infrastructure. Please redirect to the correct category tab.`);
        }
      }
